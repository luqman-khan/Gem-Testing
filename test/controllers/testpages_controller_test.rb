...
class TestpagesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create testpage" do
    assert_difference('Testpage.count') do
      post testpages_url, params: { testpage: { end_date: @testpage.end_date, hours_worked: @testpage.hours_worked, name: @testpage.name, start_date: @testpage.start_date } }
    end
  ...
  test "should update testpage" do
    patch testpage_url(@testpage), params: { testpage: { end_date: @testpage.end_date, hours_worked: @testpage.hours_worked, name: @testpage.name, start_date: @testpage.start_date } }
